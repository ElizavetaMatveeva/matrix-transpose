...
int** copyMassiv(int** m, int** m1, int* sz1, int* sz2); // Функция, копирующая в новый массив элементы в нужном порядке
...
int** changeRect(int** m, int* sz1, int* sz2){ // Функция, транспонирующая прямоугольную матрицу
	...
	m1=copyMassiv(m, m1, sz1, sz2); // В новый массив копируются все элементы в нужном порядке
